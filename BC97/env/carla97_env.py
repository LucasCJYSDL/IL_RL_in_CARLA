...
class Env:
    ...
    def reset_metrics(self):
        ...
        self.res['total_reward'] = 0
        self.res['mean_reward'] = 0.0
        self.res['ego_jerk'] = 0
        self.res['other_jerk'] = 0
    ...
    def step(self, action, lateral, longitude):
        ...
        self.res['other_jerk'] += self.walkers.get_disruption()
    ...
    def get_state(self, data, debug=False):
        ...
        points = data['Lidar'][0]
        lidar = pre_process_lidar(points, 360)
        if debug:
        ...
        measure.append(data['min_dis'] / 2.0)
    ...
    def get_reward_done(self, data, info):
        ...
        reward.append(data['speed'] > 30.0)

        reward.append(data['min_dis']) # 0.05 > 1
    ...
    def close(self, expected_end_steps):
        ...
        self.res['mean_reward'] = self.res['total_reward'] / self.res['tot_step']
