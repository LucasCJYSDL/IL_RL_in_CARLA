...
from env.utils import INSIDE, get_area, get_PED_area, get_intention
        ...
        for walker in self.walkers:
            ...
            if dis < 5.0:
                ...
                if (abs(angle - 180) <= 45 or angle <= 45 or angle >= 315) and dis < 2.5:
                    self.world.debug.draw_point(walker.get_location() + carla.Location(z=0.25), 0.1,
                                                carla.Color(0, 255, 0), 1.0, False)
                    flag=1
