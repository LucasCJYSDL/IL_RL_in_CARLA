...
class EgoCar:
    ...
    def get_sensors(self, frame0, debug=False):
        ...
        neighbor_wp, next_wp, min_dis = get_closet_wp(self.path, current.location, self.world.debug, draw_dis=True)
        ...
        #area = get_polygan(self.world.debug, current.location, next_loc_yaw, neighbor_wp.transform.location, next_wp.transform.location, draw_dis)
        #data['area'] = area
