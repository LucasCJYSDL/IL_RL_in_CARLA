...
class DataCollector:
    ...
    def collect_episode(self, scene, debug=False):
...
def main():
    ...
    parser.add_argument('--scenes', nargs='+', type=int, help='scene ID for collecting data') #TODO: you have to specify it
    parser.add_argument('--iters', default=40, type=int, help='trajector each pose and branch')
