...
def main():
    ...
    parser.add_argument('--scenes', nargs='+', type=int, help='scene ID for evaluating') #you have to specify it
    parser.add_argument('--iters', default=10, type=int, help='evaluate episodes')
    
    parser.add_argument('--lateral', type=str, choices=['NN', 'PID', 'PID_NOISE', 'TTC']) # You Must Specify It!
    parser.add_argument('--longitude', type=str, choices=['NN', 'PID', 'TTC']) # You Must Specify It!
