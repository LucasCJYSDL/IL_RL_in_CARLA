...
class EgoCar:
    ...
    def get_setup(self):
        ...
        path = np.array([np.array([self.path[i][0].transform.location.x, self.path[i][0].transform.location.y, self.path[i][0].transform.location.z]) for i in range(len(self.path))])
