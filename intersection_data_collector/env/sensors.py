...
camera_list = [
    ...
    },
    {
        ...
        'pos': carla.Transform(carla.Location(x=0.0, z=2.0)),
        'convertor': None
    },
    #{
    #    'name': 'bv_rgb',
...
class CameraSensor:
    ...
    def __init__(self, world, vehicle, camera):
        ...
        elif not self.type.startswith('sensor.other'):
    ...
    def get_data(self, frame0):
        ...
        elif self.type.startswith('sensor.other'):
            relative_acc = event.accelerometer
            relative_acc = np.array([relative_acc.x, relative_acc.y, relative_acc.z])
            # print("relative_acc: ", relative_acc)
            return relative_acc
