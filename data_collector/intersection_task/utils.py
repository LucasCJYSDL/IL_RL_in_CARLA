...
def write_hdf5(file_name, group_name, sensors_list, measures_list, task_type_list, center):
    ...
    for i in range(lent):
        ...
        result['Measurement'].append(get_measurement(i, measures_list, center))
...
def get_measurement(ind, measures_list, center):
    ...
    direction = [0] * 4
    direction[measures_list[ind]['direction']] =1

    measurement.extend(direction)
    #print(measurement)
